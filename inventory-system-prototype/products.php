            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div id="add-new-product" class="place-right">
                        <a class="btn boxed-turquoise bold" href="add-new.php"><span>Add New Product</span></a>
                    </div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="options align-center">
                                    <a class="btn btn-blue btn-icon-right btn-arrow-right" href="product-info.php"><span>View Full Info</span></a>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="options align-center">
                                    <a class="btn btn-blue btn-icon-right btn-arrow-right align-center" href="product-info.php"><span>View Full Info</span></a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
